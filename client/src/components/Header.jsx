...
const Header = () => {
  return (
    ...
    <p className='my-6 text-[15px] text-gray-500'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br className='max-sm:hidden' /> Sed vel libero et velit dignissim vestibulum.</p>
    <div>
